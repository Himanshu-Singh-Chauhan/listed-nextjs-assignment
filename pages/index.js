    ...
    <div className={styles.container}>
      ...
      <main>
        ...
        <div className="flex flex-row items-stretch h-screen ">
          {/* Side bar */}
          <div className="flex w-96 bg-black items-center justify-center -md:hidden">
            <p className=" text-5xl font-bold text-white ">Board.</p>
          </div>

          {/* Sign In section */}
          <div className=" flex flex-col bg-[#F5F5F5] grow items-center justify-center">
            {/* Sign IN section -main box */}
            <div className="m-6 "> {/* outer div  bg-orange-200*/}
              <div className="text-4xl font-bold text-black">Sign In</div>

              <div className="pt-2 text-1xl">Sign in to your account</div>

              <div className="flex flex-row justify-between -sm:justify-start">
                <button className="bg-white px-4 py-1 mt-4 mb-4 rounded-2xl -sm:mr-2" onClick={() => signIn()}>

                <svg className="inline mb-1" width="18" height="18" viewBox="0 0 14 14" fill="none" >
                ...
                </svg>  <span className="-sm:hidden">&nbsp;Sign In with Google</span>
                </button>


                <button className="bg-white  px-4 py-1 mt-4 mb-4 rounded-2xl">
                <svg className="inline mb-1" width="22" height="22" viewBox="0 0 12 14" fill="none" >
                ...
                </svg>  <span className="-sm:hidden">&nbsp;Sign In with Apple</span>
                </button>
              </div>
