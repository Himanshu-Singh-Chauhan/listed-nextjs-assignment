...
import PieChart from "../components/dash-components/PieChart";
  ...
  return (
    <>
      ...
      <div className="flex flex-row bg-[#F9FAFB]">
        <div className="w-80 h-screen sticky top-0 left-0 overflow-y-auto p-8 -xl:hidden">
          <NavBar />
        </div>
          ...
          <div className="flex flex-col sm:flex-row content-center justify-between ">
            ...
            <div className="flex flex-row">
              <div className="inline relative">
                <input
                  className="appearance-none bg-white rounded-xl w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  type="search"
                  id="search"
                  placeholder="Search..."
                />
...
function Card() {
  return (
    <div className="grid justify-items-center grid-cols-2 gap-2 md:gap-10 md:grid-cols-4  mt-4">
      <div className="p-6 pb-3 bg-[#DDEFE0] rounded-3xl max-w-[15rem] w-full ">
      ...
      <div className="p-6 pb-3 bg-[#F4ECDD] rounded-3xl max-w-[15rem] w-full ">
        ...
        <h1 className="text-xl font-bold">234</h1>
      </div>

      <div className="p-6 pb-3 bg-[#EFDADA] rounded-3xl max-w-[15rem] w-full ">
        <div className="pb-2 flex justify-end">
        ...
        <h5 className="">Total Likes</h5>
        <h1 className="text-xl font-bold">1021</h1>
      </div>

      <div className="p-6 pb-3 bg-[#DEE0EF] rounded-3xl max-w-[15rem] w-full ">
        <div className="pb-2 flex justify-end">
...
function InfoCard2() {
  return (
    <div className="basis-1/2 bg-white rounded-3xl mt-6 md:ml-6 p-6">
...
function InfoCard1() {
  return (
    <div className="  basis-1/2 bg-white rounded-3xl mt-6 md:mr-6 p-6">
      <div className="flex justify-between">
